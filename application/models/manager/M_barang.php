...
class M_barang extends CI_Model
{
	function data_barang()
	{
		...
		return $this->db->query("SELECT kode,id_stok_b,qty,kode_unik,barang_terdaftar.nama AS nama_barang,barcode,id_toko,hrg_distributor,tanggal,distributor.nama AS nama_distributor FROM stok_barang JOIN barang_terdaftar USING(kode) JOIN pemasokan
