		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="tab-content custom-menu-content">
					...
					<div id="Home4"
						class="tab-pane <?= $this->uri->segment(1) == 'pemasokan' ? 'active' : ''?> in notika-tab-menu-bg animated flipInX">
						<ul class="notika-main-menu-dropdown">
							<li>
					...
					<div id="Home5"
						class="tab-pane <?= $this->uri->segment(1) == 'barang_barcode' ? 'active' : ''?> in notika-tab-menu-bg animated flipInX">
						<ul class="notika-main-menu-dropdown">
							<li>
