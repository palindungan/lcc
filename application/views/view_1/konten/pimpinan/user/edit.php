					...
					<div class="row">
						<form action="<?php echo base_url("pimpinan/user/update") ?>" method="post">
							<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
								<div
									class="form-group <?php if(form_error('nama_user')== true) { echo "has-error";} ?>">
								...
								<div class="form-group">
									...
									<select class="form-control" name="id_toko">
										...
										<option value="<?php echo $toko->id_toko ?>"
											<?php echo $toko->id_toko==$data->id_toko ?  "selected" : "" ?>>
											<?php echo $toko->nama_toko ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
